...
public class M4jdslValidator extends EObjectValidator {
    ...
    protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
        switch (classifierID) {
            ...
            case M4jdslPackage.NORMAL_DISTRIBUTION:
    ...
    public boolean validateApplicationState(ApplicationState applicationState, DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        if (result || diagnostics != null) result &= validateApplicationState_mustBeExitStateWithoutTransitions(applicationState, diagnostics, context);
        return result;
    }
    ...
    /**
     * The cached validation expression for the mustBeExitStateWithoutTransitions constraint of '<em>Application State</em>'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected static final String APPLICATION_STATE__MUST_BE_EXIT_STATE_WITHOUT_TRANSITIONS__EEXPRESSION = "\n" +
        "        SessionLayerEFSM.allInstances()->exists(s|s.exitState = self) implies outgoingTransitions->isEmpty()";

    /**
     * Validates the mustBeExitStateWithoutTransitions constraint of '<em>Application State</em>'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public boolean validateApplicationState_mustBeExitStateWithoutTransitions(ApplicationState applicationState, DiagnosticChain diagnostics, Map<Object, Object> context) {
        return
            validate
                (M4jdslPackage.Literals.APPLICATION_STATE,
                 applicationState,
                 ...
                 context,
                 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
                 "mustBeExitStateWithoutTransitions",
                 APPLICATION_STATE__MUST_BE_EXIT_STATE_WITHOUT_TRANSITIONS__EEXPRESSION,
                 Diagnostic.ERROR,
                 DIAGNOSTIC_SOURCE,
                 0);
    }
    ...
    public boolean validateHTTPRequest(HTTPRequest httpRequest, DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        if (result || diagnostics != null) result &= validateHTTPRequest_mustBeUniquePropertyNames(httpRequest, diagnostics, context);
        if (result || diagnostics != null) result &= validateHTTPRequest_mustBeUniqueParameterNames(httpRequest, diagnostics, context);
        return result;
    }

    /**
     * The cached validation expression for the mustBeUniquePropertyNames constraint of '<em>HTTP Request</em>'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected static final String HTTP_REQUEST__MUST_BE_UNIQUE_PROPERTY_NAMES__EEXPRESSION = "\n" +
        "         properties->forAll(p1,p2 | p1 <> p2 implies p1.key <> p2.key)";

    /**
     * Validates the mustBeUniquePropertyNames constraint of '<em>HTTP Request</em>'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public boolean validateHTTPRequest_mustBeUniquePropertyNames(HTTPRequest httpRequest, DiagnosticChain diagnostics, Map<Object, Object> context) {
        return
            validate
                (M4jdslPackage.Literals.HTTP_REQUEST,
                 httpRequest,
                 diagnostics,
                 context,
                 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
                 "mustBeUniquePropertyNames",
                 HTTP_REQUEST__MUST_BE_UNIQUE_PROPERTY_NAMES__EEXPRESSION,
                 Diagnostic.ERROR,
                 DIAGNOSTIC_SOURCE,
                 0);
    }
    ...
    /**
     * The cached validation expression for the mustBeUniqueParameterNames constraint of '<em>HTTP Request</em>'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected static final String HTTP_REQUEST__MUST_BE_UNIQUE_PARAMETER_NAMES__EEXPRESSION = "\n" +
        "        parameters-> forAll(p1,p2 | p1 <> p2 implies p1.name <> p2.name)";

    /**
     * Validates the mustBeUniqueParameterNames constraint of '<em>HTTP Request</em>'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public boolean validateHTTPRequest_mustBeUniqueParameterNames(HTTPRequest httpRequest, DiagnosticChain diagnostics, Map<Object, Object> context) {
        return
            validate
                (M4jdslPackage.Literals.HTTP_REQUEST,
                 httpRequest,
                 ...
                 HTTP_REQUEST__MUST_BE_UNIQUE_PARAMETER_NAMES__EEXPRESSION,
                 Diagnostic.ERROR,
                 DIAGNOSTIC_SOURCE,
                 0);
    }
    ...
    public boolean validateProtocolState(ProtocolState protocolState, DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        if (result || diagnostics != null) result &= validateProtocolState_mustBeExitStateWithoutTransitions(protocolState, diagnostics, context);
        return result;
    }
    ...
    /**
     * The cached validation expression for the mustBeExitStateWithoutTransitions constraint of '<em>Protocol State</em>'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected static final String PROTOCOL_STATE__MUST_BE_EXIT_STATE_WITHOUT_TRANSITIONS__EEXPRESSION = "\n" +
        "        ProtocolLayerEFSM.allInstances()->exists(s|s.exitState = self) implies outgoingTransitions->isEmpty()";

    /**
     * Validates the mustBeExitStateWithoutTransitions constraint of '<em>Protocol State</em>'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public boolean validateProtocolState_mustBeExitStateWithoutTransitions(ProtocolState protocolState, DiagnosticChain diagnostics, Map<Object, Object> context) {
        return
            validate
                (M4jdslPackage.Literals.PROTOCOL_STATE,
                 protocolState,
                 ...
                 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
                 "mustBeExitStateWithoutTransitions",
                 PROTOCOL_STATE__MUST_BE_EXIT_STATE_WITHOUT_TRANSITIONS__EEXPRESSION,
                 Diagnostic.ERROR,
                 DIAGNOSTIC_SOURCE,
                 0);
    }
    ...
    public boolean validateProtocolLayerEFSM(ProtocolLayerEFSM protocolLayerEFSM, DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        if (result || diagnostics != null) result &= validateProtocolLayerEFSM_mustBeStateListIncludingInitialStateAndExitState(protocolLayerEFSM, diagnostics, context);
    ...
    /**
     * The cached validation expression for the mustBeStateListIncludingInitialStateAndExitState constraint of '<em>Protocol Layer EFSM</em>'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected static final String PROTOCOL_LAYER_EFSM__MUST_BE_STATE_LIST_INCLUDING_INITIAL_STATE_AND_EXIT_STATE__EEXPRESSION = "\n" +
        "            states->includesAll(Set{initialState, exitState})";

    /**
     * Validates the mustBeStateListIncludingInitialStateAndExitState constraint of '<em>Protocol Layer EFSM</em>'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public boolean validateProtocolLayerEFSM_mustBeStateListIncludingInitialStateAndExitState(ProtocolLayerEFSM protocolLayerEFSM, DiagnosticChain diagnostics, Map<Object, Object> context) {
        return
            validate
                (M4jdslPackage.Literals.PROTOCOL_LAYER_EFSM,
                 ...
                 context,
                 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
                 "mustBeStateListIncludingInitialStateAndExitState",
                 PROTOCOL_LAYER_EFSM__MUST_BE_STATE_LIST_INCLUDING_INITIAL_STATE_AND_EXIT_STATE__EEXPRESSION,
                 Diagnostic.ERROR,
                 DIAGNOSTIC_SOURCE,
                 0);
    }
    ...
    public boolean validateSessionLayerEFSM(SessionLayerEFSM sessionLayerEFSM, DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        if (result || diagnostics != null) result &= validateSessionLayerEFSM_mustBeStateListIncludingInitialStateAndExitState(sessionLayerEFSM, diagnostics, context);
    ...
    /**
     * The cached validation expression for the mustBeStateListIncludingInitialStateAndExitState constraint of '<em>Session Layer EFSM</em>'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected static final String SESSION_LAYER_EFSM__MUST_BE_STATE_LIST_INCLUDING_INITIAL_STATE_AND_EXIT_STATE__EEXPRESSION = "\n" +
        "            states->includesAll(Set{initialState, exitState})";

    /**
     * Validates the mustBeStateListIncludingInitialStateAndExitState constraint of '<em>Session Layer EFSM</em>'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public boolean validateSessionLayerEFSM_mustBeStateListIncludingInitialStateAndExitState(SessionLayerEFSM sessionLayerEFSM, DiagnosticChain diagnostics, Map<Object, Object> context) {
        return
            validate
                (M4jdslPackage.Literals.SESSION_LAYER_EFSM,
                 ...
                 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
                 "mustBeStateListIncludingInitialStateAndExitState",
                 SESSION_LAYER_EFSM__MUST_BE_STATE_LIST_INCLUDING_INITIAL_STATE_AND_EXIT_STATE__EEXPRESSION,
                 Diagnostic.ERROR,
                 DIAGNOSTIC_SOURCE,
                 0);
    }
    ...
    public boolean validateNormalDistribution(NormalDistribution normalDistribution, DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        if (result || diagnostics != null) result &= validateNormalDistribution_mustBeValidThinkTimeValues(normalDistribution, diagnostics, context);
        return result;
    }

    /**
     * The cached validation expression for the mustBeValidThinkTimeValues constraint of '<em>Normal Distribution</em>'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected static final String NORMAL_DISTRIBUTION__MUST_BE_VALID_THINK_TIME_VALUES__EEXPRESSION = "\n" +
        "            mean >= 0.0 and deviation >= 0.0 and deviation <= mean";

    /**
     * Validates the mustBeValidThinkTimeValues constraint of '<em>Normal Distribution</em>'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public boolean validateNormalDistribution_mustBeValidThinkTimeValues(NormalDistribution normalDistribution, DiagnosticChain diagnostics, Map<Object, Object> context) {
        return
            validate
                (M4jdslPackage.Literals.NORMAL_DISTRIBUTION,
                 normalDistribution,
                 diagnostics,
                 context,
                 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
                 "mustBeValidThinkTimeValues",
                 NORMAL_DISTRIBUTION__MUST_BE_VALID_THINK_TIME_VALUES__EEXPRESSION,
                 Diagnostic.ERROR,
                 DIAGNOSTIC_SOURCE,
                 0);
    }
