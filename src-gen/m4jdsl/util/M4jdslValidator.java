...
public class M4jdslValidator extends EObjectValidator {
    ...
    public boolean validateSessionLayerEFSM(SessionLayerEFSM sessionLayerEFSM, DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        if (result || diagnostics != null) result &= validateSessionLayerEFSM_mustBeStateListIncludingInitialState(sessionLayerEFSM, diagnostics, context);
    ...
    /**
     * The cached validation expression for the mustBeStateListIncludingInitialState constraint of '<em>Session Layer EFSM</em>'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected static final String SESSION_LAYER_EFSM__MUST_BE_STATE_LIST_INCLUDING_INITIAL_STATE__EEXPRESSION = "\n" +
        "            applicationStates->includesAll(Set{initialState})";

    /**
     * Validates the mustBeStateListIncludingInitialState constraint of '<em>Session Layer EFSM</em>'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public boolean validateSessionLayerEFSM_mustBeStateListIncludingInitialState(SessionLayerEFSM sessionLayerEFSM, DiagnosticChain diagnostics, Map<Object, Object> context) {
        return
            validate
                (M4jdslPackage.Literals.SESSION_LAYER_EFSM,
                 ...
                 SESSION_LAYER_EFSM__MUST_BE_STATE_LIST_INCLUDING_INITIAL_STATE__EEXPRESSION,
                 Diagnostic.ERROR,
                 DIAGNOSTIC_SOURCE,
                 0);
    }
