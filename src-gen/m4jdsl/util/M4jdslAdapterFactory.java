...
public class M4jdslAdapterFactory extends AdapterFactoryImpl {
    ...
    protected M4jdslSwitch<Adapter> modelSwitch =
        new M4jdslSwitch<Adapter>() {
			...
			@Override
			public Adapter caseBeanShellRequest(BeanShellRequest object) {
				return createBeanShellRequestAdapter();
			}
			@Override
			public Adapter caseJUnitRequest(JUnitRequest object) {
				return createJUnitRequestAdapter();
			}
			@Override
			public Adapter caseSOAPRequest(SOAPRequest object) {
				return createSOAPRequestAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseGuardActionParameter(GuardActionParameter object) {
				return createGuardActionParameterAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseGuardActionParameterList(GuardActionParameterList object) {
				return createGuardActionParameterListAdapter();
			}
			@Override
    ...
    /**
	 * Creates a new adapter for an object of class '{@link m4jdsl.BeanShellRequest <em>Bean Shell Request</em>}'.
	 * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
    public Adapter createBeanShellRequestAdapter() {
		return null;
	}

    /**
	 * Creates a new adapter for an object of class '{@link m4jdsl.JUnitRequest <em>JUnit Request</em>}'.
	 * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
    public Adapter createJUnitRequestAdapter() {
		return null;
	}

    /**
	 * Creates a new adapter for an object of class '{@link m4jdsl.SOAPRequest <em>SOAP Request</em>}'.
	 * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
    public Adapter createSOAPRequestAdapter() {
		return null;
	}
    ...
    /**
	 * Creates a new adapter for an object of class '{@link m4jdsl.GuardActionParameter <em>Guard Action Parameter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGuardActionParameterAdapter() {
		return null;
	}

				/**
	 * Creates a new adapter for an object of class '{@link m4jdsl.Guard <em>Guard</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	public Adapter createGuardAdapter() {
		return null;
				...
				/**
	 * Creates a new adapter for an object of class '{@link m4jdsl.Action <em>Action</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	public Adapter createActionAdapter() {
		return null;
				...
				/**
	 * Creates a new adapter for an object of class '{@link m4jdsl.GuardActionParameterList <em>Guard Action Parameter List</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGuardActionParameterListAdapter() {
		return null;
	}
