...
public class M4jdslPackageImpl extends EPackageImpl implements M4jdslPackage {
	 ...
	 * @generated
	 */
	private EClass guardActionParameterEClass = null;
	 ...
	 * @generated
	 */
	private EClass guardActionParameterListEClass = null;
	 ...
	 * @generated
	 */
	public EReference getSessionLayerEFSM_GuardActionParameterList() {
		return (EReference)sessionLayerEFSMEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
    @Override
    public EReference getApplicationTransition_Action() {
		return (EReference)applicationTransitionEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
    @Override
    public EReference getApplicationTransition_Guard() {
		return (EReference)applicationTransitionEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getGuardActionParameter() {
		return guardActionParameterEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getGuardActionParameter_GuardActionParameterName() {
		return (EAttribute)guardActionParameterEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getGuardActionParameter_ParameterType() {
		return (EAttribute)guardActionParameterEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getGuard_GuardParameter() {
	 ...
	 * @generated
	 */
	public EClass getGuardActionParameterList() {
		return guardActionParameterListEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getGuardActionParameterList_GuardActionParameters() {
		return (EReference)guardActionParameterListEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EEnum getGuardActionParameterType() {
		return guardActionParameterTypeEEnum;
	}
    ...
    public void createPackageContents() {
		...
		createEReference(sessionLayerEFSMEClass, SESSION_LAYER_EFSM__GUARD_ACTION_PARAMETER_LIST);
    ...
    public void initializePackageContents() {
		...
		initEReference(getSessionLayerEFSM_GuardActionParameterList(), this.getGuardActionParameterList(), null, "guardActionParameterList", null, 1, 1, SessionLayerEFSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
