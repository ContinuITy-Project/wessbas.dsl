...
public class M4jdslPackageImpl extends EPackageImpl implements M4jdslPackage {
     ...
     * @generated
     */
    public EAttribute getMarkovState_EId() {
        return (EAttribute)markovStateEClass.getEStructuralFeatures().get(2);
    }
     ...
     * @generated
     */
    public EAttribute getApplicationState_EId() {
        return (EAttribute)applicationStateEClass.getEStructuralFeatures().get(3);
    }
     ...
     * @generated
     */
    public EReference getHTTPRequest_Properties() {
     ...
     * @generated
     */
    public EAttribute getProtocolState_EId() {
        return (EAttribute)protocolStateEClass.getEStructuralFeatures().get(2);
    }
     ...
     * @generated
     */
    public EReference getProtocolLayerEFSM_States() {
     ...
     * @generated
     */
    public EReference getSessionLayerEFSM_States() {
     ...
     * @generated
     */
    public EAttribute getNormalDistribution_Deviation() {
    ...
    public void createPackageContents() {
        ...
        createEAttribute(markovStateEClass, MARKOV_STATE__EID);
        ...
        createEAttribute(applicationStateEClass, APPLICATION_STATE__EID);

        httpRequestEClass = createEClass(HTTP_REQUEST);
        createEReference(httpRequestEClass, HTTP_REQUEST__PROPERTIES);
        ...
        createEAttribute(protocolStateEClass, PROTOCOL_STATE__EID);
        ...
        createEReference(protocolLayerEFSMEClass, PROTOCOL_LAYER_EFSM__STATES);
        ...
        createEReference(sessionLayerEFSMEClass, SESSION_LAYER_EFSM__STATES);
        ...
        createEAttribute(normalDistributionEClass, NORMAL_DISTRIBUTION__DEVIATION);
    ...
    public void initializePackageContents() {
        ...
        normalDistributionEClass.getESuperTypes().add(this.getThinkTime());
        ...
        initEReference(getTransition_TargetState(), this.getMarkovState(), null, "targetState", null, 1, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getMarkovState_EId(), ecorePackage.getEString(), "eId", null, 1, 1, MarkovState.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getApplicationState_EId(), ecorePackage.getEString(), "eId", null, 1, 1, ApplicationState.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(httpRequestEClass, HTTPRequest.class, "HTTPRequest", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getHTTPRequest_Properties(), this.getProperty(), null, "properties", null, 0, -1, HTTPRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getProtocolState_EId(), ecorePackage.getEString(), "eId", null, 1, 1, ProtocolState.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getProtocolTransition_TargetState(), this.getProtocolState(), null, "targetState", null, 1, 1, ProtocolTransition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getProtocolLayerEFSM_States(), this.getProtocolState(), null, "states", null, 1, -1, ProtocolLayerEFSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getProtocolLayerEFSM_ExitState(), this.getProtocolState(), null, "exitState", null, 1, 1, ProtocolLayerEFSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getSessionLayerEFSM_States(), this.getApplicationState(), null, "states", null, 1, -1, SessionLayerEFSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getSessionLayerEFSM_ExitState(), this.getApplicationState(), null, "exitState", null, 1, 1, SessionLayerEFSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getApplicationTransition_TargetState(), this.getApplicationState(), null, "targetState", null, 1, 1, ApplicationTransition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getNormalDistribution_Mean(), ecorePackage.getEDouble(), "mean", null, 1, 1, NormalDistribution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getNormalDistribution_Deviation(), ecorePackage.getEDouble(), "deviation", null, 1, 1, NormalDistribution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    protected void createEcoreAnnotations() {
        ...
        addAnnotation
          (behaviorModelEClass, 
           source, 
           new String[] {
             "constraints", "mustBeUniqueNames mustBeBehaviorModelWithMarkovStatesForAllServices"
           });			
        addAnnotation
          (transitionEClass, 
           source, 
           new String[] {
             "constraints", "mustBeValidProbability mustBeEqualThinkTimeTypes"
           });			
        addAnnotation
          (markovStateEClass, 
           source, 
        ...
        addAnnotation
          (applicationStateEClass, 
           source, 
           new String[] {
             "constraints", "mustBeUniqueOutgoingTransitionTargetStates mustBeExitStateWithoutTransitions"
           });			
        addAnnotation
          (httpRequestEClass, 
           source, 
           new String[] {
             "constraints", "mustBeUniquePropertyNames mustBeUniqueParameterNames"
           });			
        addAnnotation
          (requestEClass, 
           source, 
        ...
        addAnnotation
          (protocolLayerEFSMEClass, 
           source, 
           new String[] {
             "constraints", "mustBeStateListIncludingInitialStateAndExitState mustBeProtocolStatesWithUniqueRequests"
           });			
        addAnnotation
          (sessionLayerEFSMEClass, 
           source, 
           new String[] {
             "constraints", "mustBeStateListIncludingInitialStateAndExitState mustBeApplicationStatesWithUniqueServices"
           });			
        addAnnotation
