...
public class ProtocolTransitionImpl extends MinimalEObjectImpl.Container implements ProtocolTransition {
     ...
     * @ordered
     */
    protected ProtocolState targetState;
     ...
     * @generated
     */
    public ProtocolState getTargetState() {
        if (targetState != null && targetState.eIsProxy()) {
            InternalEObject oldTargetState = (InternalEObject)targetState;
            targetState = (ProtocolState)eResolveProxy(oldTargetState);
     ...
     * @generated
     */
    public ProtocolState basicGetTargetState() {
        return targetState;
    }
     ...
     * @generated
     */
    public void setTargetState(ProtocolState newTargetState) {
        ProtocolState oldTargetState = targetState;
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            case M4jdslPackage.PROTOCOL_TRANSITION__GUARD:
                ...
                return;
            case M4jdslPackage.PROTOCOL_TRANSITION__TARGET_STATE:
                setTargetState((ProtocolState)newValue);
                return;
            case M4jdslPackage.PROTOCOL_TRANSITION__ACTION:
    ...
    public void eUnset(int featureID) {
        switch (featureID) {
            case M4jdslPackage.PROTOCOL_TRANSITION__GUARD:
                ...
                return;
            case M4jdslPackage.PROTOCOL_TRANSITION__TARGET_STATE:
                setTargetState((ProtocolState)null);
                return;
            case M4jdslPackage.PROTOCOL_TRANSITION__ACTION:
