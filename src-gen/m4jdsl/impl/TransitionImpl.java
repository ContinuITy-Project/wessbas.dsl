...
public class TransitionImpl extends MinimalEObjectImpl.Container implements Transition {
     ...
     * @ordered
     */
    protected MarkovState targetState;
    ...
    public MarkovState getTargetState() {
        if (targetState != null && targetState.eIsProxy()) {
            ...
            targetState = (MarkovState)eResolveProxy(oldTargetState);
     ...
     * @generated
     */
    public MarkovState basicGetTargetState() {
        return targetState;
    }
     ...
     * @generated
     */
    public void setTargetState(MarkovState newTargetState) {
        MarkovState oldTargetState = targetState;
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            case M4jdslPackage.TRANSITION__TARGET_STATE:
                setTargetState((MarkovState)newValue);
                return;
            case M4jdslPackage.TRANSITION__PROBABILITY:
    ...
    public void eUnset(int featureID) {
        switch (featureID) {
            case M4jdslPackage.TRANSITION__TARGET_STATE:
                setTargetState((MarkovState)null);
                return;
            case M4jdslPackage.TRANSITION__PROBABILITY:
