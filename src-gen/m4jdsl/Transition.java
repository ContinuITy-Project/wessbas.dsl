 ...
 * @model annotation="http://www.eclipse.org/emf/2002/Ecore constraints='mustBeValidProbability mustBeEqualThinkTimeTypes'"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot mustBeValidProbability='\n            probability >= 0.0 and probability <= 1.0' mustBeEqualThinkTimeTypes='\n            Transition.allInstances()->\n                forAll(t1,t2|t1.thinkTime->oclType() = t2.thinkTime->oclType())'"
 * @generated
 */
public interface Transition extends EObject {
     ...
     * @see #setTargetState(MarkovState)
     * @see m4jdsl.M4jdslPackage#getTransition_TargetState()
     * @model required="true"
     * @generated
     */
    MarkovState getTargetState();
     ...
     * @generated
     */
    void setTargetState(MarkovState value);
