 ...
 * @model annotation="http://www.eclipse.org/emf/2002/Ecore constraints='mustBeStateListIncludingInitialState mustBeApplicationStatesWithUniqueServices'"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot mustBeStateListIncludingInitialState='\n            applicationStates->includesAll(Set{initialState})' mustBeApplicationStatesWithUniqueServices='\n            applicationStates->forAll(s1,s2|s1 <> s2 implies s1.service <> s2.service)'"
 * @generated
 */
